import $ from 'jquery'
$(function () {
  var url = encodeURIComponent('http://hbte.vaiwan.com/DingTalkTest/login.html')
  var obj = DDLogin({
  ...
  var handleMessage = function (event) {
    ...
    if (origin == 'https://login.dingtalk.com') { // 判断是否来自ddLogin扫码事件。
      ...
      request.url = 'http://localhost:8081/loginTmp?authCode=' + loginTmpCode
      console.log(request.url)

      window.location.href = 'http://localhost:8848/DingTalkTest/index.html?tmpAuthCode=' + loginTmpCode
