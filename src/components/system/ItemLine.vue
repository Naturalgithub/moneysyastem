<template>
  <div class="users">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>产品线管理</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索框 -->
    ...
    <!-- 按钮添加 -->
    <el-button class="addBtn" type="success" plain @click="dialogVisible = true">产品线添加</el-button>

    <!-- 表格组件 -->
    <el-table :data="momeyManagementList" border style="width: 100%" size="mini">
      <el-table-column type="index" label="序号" width="50"></el-table-column>
      <el-table-column prop="productLineName" label="产品线名称"></el-table-column>
    ...
    <el-dialog title="产品线管理" :visible.sync="dialogVisible" width="40%">
      <el-form ref="form" :model="form" status-icon label-width="100px">
        <el-form-item label="产品线名称">
          <el-input placeholder="产品线名称" v-model="form.productLineName"></el-input>
        </el-form-item>

        <el-form-item label="产品线编码">
          <el-input placeholder="产品线编码" v-model="form.productLineCode"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="修改" :visible.sync="editVisible" width="40%">
      <el-form ref="editForm" :model="editForm" :rules="rules" label-width="80px">
        <el-form-item label="产品线名称">
          <el-input placeholder="请输入产品线名称" v-model="editForm.productLineName"></el-input>
        </el-form-item>
        <el-form-item label="产品线编码" prop="email">
          <el-input placeholder="请输入编码" v-model="editForm.productLineCode"></el-input>
        </el-form-item>
      </el-form>
