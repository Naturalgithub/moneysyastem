<template>
  <div class="users">
    ...
    <!-- 按钮添加 -->
    <el-button class="addBtn" type="success" plain @click="dialogVisible = true">项目添加</el-button>

    <!-- 表格组件 -->
    <el-table :data="momeyManagementList" border style="width: 100%" size="mini">
      <el-table-column type="index" label="序号"></el-table-column>
      <el-table-column prop="paymentTermName" label="项目名称"></el-table-column>
    ...
    <el-dialog title="项目管理" :visible.sync="dialogVisible" width="40%">
      <el-form ref="form" :model="form" status-icon label-width="100px">
        <el-form-item label="项目名称">
          <el-input placeholder="项目名称" v-model="form.paymentTermName"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="修改" :visible.sync="editVisible" width="40%">
      <el-form ref="editForm" :model="editForm" :rules="rules" label-width="80px">
        <el-form-item label="项目名称">
          <el-input placeholder="请输入项目名称" v-model="editForm.paymentTermName"></el-input>
        </el-form-item>
      </el-form>
