<template>
  <div class="users">
    ...
    <!-- 按钮添加 -->
    <el-button class="addBtn" type="success" plain @click="dialogVisible = true">货币添加</el-button>
    ...
    <el-dialog title="货币管理" :visible.sync="dialogVisible" width="40%">
      <el-form ref="form" :model="form" status-icon label-width="100px">
        <el-form-item label="货币名称">
          <el-input placeholder="货币名称" v-model="form.currencyName"></el-input>
        </el-form-item>

        <el-form-item label="货币兑率">
          <el-input placeholder="货币兑率" v-model="form.currencyRatio"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="修改" :visible.sync="editVisible" width="40%">
      <el-form ref="editForm" :model="editForm" :rules="rules" label-width="80px">
        <el-form-item label="货币名称">
          <el-input placeholder="请输入货币名称" v-model="editForm.currencyName"></el-input>
        </el-form-item>
        <el-form-item label="货币兑率" prop="email">
          <el-input placeholder="请输入兑率" v-model="editForm.currencyRatio"></el-input>
        </el-form-item>
      </el-form>
